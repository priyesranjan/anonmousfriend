...
class _CallingState extends State<Calling>
  ...
  Future<void> _moveCallToBackground() async {
    await _appTaskService.moveToBack();
  }
        ...
        children: [
          Container(
            ...
            child: IconButton(
              ...
              onPressed: _moveCallToBackground,
            ),
          ),
          const Spacer(),
          // Audio device routing is handled natively by LiveKit 
          const Spacer(),
